...
export default function Clock() {
     ...
     return (
          ...
          >
               {/* ───────── CABECERA SUPERIOR ───────── */}
               <div
                    className={`absolute top-5 left-0 right-0 flex justify-between px-10 items-center transition-opacity duration-300 ${showControls ? "opacity-100" : "opacity-0 pointer-events-none"
                         }`}
               >
                    ...
                    <div className="flex gap-3">
                         ...
                         {["12h", "24h"].map((mode) => {
                              const isActive = (mode === "12h" && use12h) || (mode === "24h" && !use12h);
                              return (
                                   <button
                                        key={mode}
               ...
               <div className="flex items-baseline justify-center mt-10">
                    <h1
                         className="text-[10rem] md:text-[15rem] font-[Space_Mono] leading-none select-none"
                         style={{
               ...
               <div className="mt-12 w-full flex justify-center border-t border-gray-400/30 dark:border-gray-100/20 pt-10">
                    <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-3 gap-6 px-6">
                         {/* CARD Clima */}
                         <div className="flex flex-col items-center justify-center bg-gray-100/10 dark:bg-white/5 rounded-2xl p-6 text-center backdrop-blur-sm">
                              <img
